...
INSERT INTO `amministratore` VALUES (1,'aldo123','aldo@libeo.it','password',1),(2,'bruno','bruno@gmail.it','passwword',2),(3,'saverio','aldo@aonnazudunna.it','passwword',3),(4,'giesuelo','giangian@outlook.it','password',4),(5,'rodolfo','rodolfo@gmail.com','password',5);
...
INSERT INTO `azienda` VALUES (1,'bevande@gmail.com','123','bevande SPA','111111','via piedi','vendiamo bevande',NULL,NULL,1),(2,'surgelati@gmail.com','234','surgelati','222222','via vai','vendiamo surgelati',NULL,NULL,2),(3,'messico@gmail.com','345','mexican foods','333333','corso veloce','vendiamo cibo etnico',NULL,NULL,3);
...
INSERT INTO `distributore` VALUES (1,'aldo123','aldo123@123.it','123','aldo','romulov','111110','1234','via sede',0,NULL,1),(2,'manfredi','manfr@hotmail.it','123','giacobbe','stianz','111112','1234','via tenente rossi',0,NULL,2),(3,'anselmo','ansia@gmail.com','123','stuart','bababa','111113','1234','corso rupestre',0,NULL,3),(4,'aldoo','4ld0@gmail.com','123','rosangelo','chiaro','111114','1234','piazza diego',0,NULL,4),(5,'menfranco','frank@libero.it','123','malbalbo','rossi','111115','1234','stretto delle meraviglie',0,NULL,5),(6,'alsazio','lorena@libero.it','123','pistrenco','verdi','111116','1234','corso lungo',0,NULL,6);
...
INSERT INTO `documento` VALUES (1,'diritti','1',NULL,NULL,NULL,1);
...
INSERT INTO `prodotto` VALUES (1,'cola',1,'bevanda gusto cola generica',50,NULL,1,1,1,1,1,0),(2,'cherry cola',1.15,'bevanda gusto cola alla ciliegia',55,NULL,1,2,1,1,2,0),(3,'cola zero',1,'bevanda gusto cola zero calorie',40,NULL,1,3,1,1,3,0),(4,'sofficini',2,'sofficini generici surgelati',60,NULL,1,1,2,2,4,0),(5,'bastoncini',2,'bastoncini di merluzzo surgelati',50,NULL,1,2,2,2,5,0),(6,'kebab',3,'kebab surgelato',40,NULL,1,3,2,2,6,0),(7,'tacos',1.5,'tacos surgelati',20,NULL,1,1,3,3,7,0),(8,'chili sauce',1,'salsa chili piccante',10,NULL,1,2,3,3,8,0),(9,'kebab piccante',3,'kebab piccante surgelato',5,NULL,1,3,3,2,9,0),(10,'spicy doritos',1.5,'tortillas chips piccanti',1,NULL,1,4,3,3,10,0);
...
-- Dump completed on 2022-01-06  9:33:35
